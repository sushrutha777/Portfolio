  ...
  return (
    <section id="experience" className="scroll-mt-24 py-10 md:py-16">
      <div className="text-center mb-16">
        <h3 className="text-4xl font-display font-extrabold text-brand-teal">Work Experience</h3>
      </div>
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="md:mr-16 glass p-8 rounded-3xl border-slate-200 dark:border-white/5 hover:border-brand-teal/20 transition-all">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 mb-6">
              <div>
                <span className="text-brand-teal text-xs font-bold uppercase tracking-widest">July 2025</span>
            ...
            <p className="text-brand-blue font-semibold text-sm mb-4">Data Science Intern</p>
