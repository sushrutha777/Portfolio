...
const Achievements: React.FC = () => {
    return (
        <section id="achievements" className="scroll-mt-24 py-10 md:py-16">
            <div className="mb-16">
                <h2 className="text-4xl font-display font-extrabold text-brand-cyan">Achievements</h2>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="group glass p-8 rounded-[2rem] border-slate-200 dark:border-white/5 hover:border-brand-cyan/20 transition-all"
                >
                    <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-6">
                        <div>
                            ...
                            <a
                                ...
                                className="inline-flex items-center gap-2 text-brand-cyan font-bold text-sm hover:underline"
                            >
